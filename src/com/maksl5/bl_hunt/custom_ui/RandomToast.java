...
public class RandomToast {
	...
	private RandomToast(Context context, CharSequence message, double probability) {
	 ...
	 */
	public static RandomToast create(Context context, CharSequence message, double probability) {

...
public abstract class Achievement {
	...
	/** The time interval in which this achievement has to be completed. 0 for no time interval. */
	private int timeInterval;

	/** The list of manufacturers for which the achievement is only calculated. */
	private List<String> manufacturerList;

	/** The preferences which must have a specific state to accomplish the achievement. */
